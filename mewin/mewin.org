...
#+end_src
#+begin_export latex
We have finished writing \ty{mewin}, time to test it.

\section{Testing}
Out testing program has hooks for imports and the testing logic.
#+end_export
#+begin_src go <<mewin_test.go>>=
  package main
...
#+end_export
#+begin_src go <<Construct tests, Ch. \ref{ch:me}>>=
  test = exec.Command("./mewin",  "-t",  "0.9954", f)
  tests = append(tests, test)
#+end_src
#+begin_export latex
...
#+end_export
#+begin_src go <<Construct tests, Ch. \ref{ch:me}>>=
  test = exec.Command("./mewin", "-t", "0.9954",
	  "-w", "50000", f)
  tests = append(tests, test)
#+end_src
#+begin_export latex
...
#+end_export
#+begin_src go <<Construct tests, Ch. \ref{ch:me}>>=
  test = exec.Command("./mewin", "-t", "0.49", "-i", f)
  tests = append(tests, test)
#+end_src
#+begin_export latex
